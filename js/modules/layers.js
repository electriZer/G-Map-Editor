define(function() {
	...
	Layers.events = {
		...
		"click #layerlist li": function (e) {
		    if (Editor.$(e.currentTarget).hasClass("disabled")) return;
		    /*if (Editor.$(e.currentTarget).hasClass("active")) {
		        Editor.$("#layerlist li").removeClass("active");
		        Editor.$(".layer").addClass("active");
		    } else {*/
		        Editor.$("#layerlist li").removeClass("active");
		...
		"click #layerlist li i:first-child": function(e) { Layers.toggleVisibility(e); },
	...
	Layers.add = function(name) {
		...
		Editor.$("#layerlist li").removeClass("active");
		Editor.$("#layerlist").append("<li class='active' data-id='" + id + "'><i class='fa fa-eye'></i> " + name + "</li>");// "<span class='fa fa-cog'></span></li>");
	...
	Layers.rename = function(e) {
		...
		Editor.$(Layers.contextTarget).html("<i class='fa fa-eye'></i> " + newName);// + "<span class='fa fa-cog'></span>");
		Editor.$("#contextmenu").remove();
	};
	...
	Layers.getActive = function() {
		...
		Editor.$(".layer[data-id=" + id + "]").addClass("active");
		return { 
	...
	Layers.getContextTarget = function () {
	    Layers.contextTarget = Editor.$("#layerlist li.active");
	}
	...
	Layers.openContextmenu = function(e) {
		...
		Editor.$.get("templates/cm_layer.html", function(data) {
